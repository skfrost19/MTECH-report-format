...
% Title format for chapter titles without number
...
% Title formats for sections, subsections, and subsubsections
\titleformat{\section}
...
\input{candidate_declaration.tex}
\clearpage
%%%%%%%%%%%%%%%%%%%  certificate_from_supervisor %%%%%%%%%%%%%%%%%%
\addcontentsline{toc}{chapter}{Certificate from Supervisor}
\input{certificate_from_supervisor.tex}
\clearpage
%%%%%%%%%%%%%%%% certificate_of_approval %%%%%%%%%%%%%%%%%%
% \addcontentsline{toc}{chapter}{Certificate of Approval}
% \input{certificate_of_approval.tex}
% \clearpage
%%%%%%%%%%%% Plagiarism Report %%%%%%%%%%%%%%%%%%%%%%%%%%
% \addcontentsline{toc}{chapter}{Plagiarism Report}
% \input{plag_report.tex}
% \clearpage
%%%%%%%%%%%%%%%% Acknowledgment %%%%%%%%%%%%%%%%%
